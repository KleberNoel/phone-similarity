...
PHONEME_FEATURES = {
    ...
    "ɬ": {"voiced": False, "place": "alveolar", "manner": "lateral_fricative"},
    "x": {"voiced": False, "place": "velar", "manner": "fricative"},
    "ʲ": {"voiced": True, "place": "palatal", "manner": "approximant"},
    "̃": {"nasalized": True},
    "ˈ": {"stress": "primary"},
    "ˌ": {"stress": "secondary"},
    "ɛ": {"mid": True, "front": True, "round": False, "tense": False, "long": False},
    # -- Vowels --
